...
filetag = "VBFHToTauTau"
#filetag = "QCD_Pt-15To7000"

inputlist = [line.rstrip() for line in open(filetag+'.list')]
#print alist
...
process.TFileService = cms.Service("TFileService",
  fileName = cms.string('output_'+filetag+'.root')
)
...
process.rerunDiscriminationByIsolationMVAPhase2VVLoose = patDiscriminationByIsolationMVArun2v1Loose.clone(
    ...
    mvaOutput_normalization = cms.string("mvaOutput_normalization_tauIdMVAIsoPhase2;1"),
    mapping = cms.VPSet(
        cms.PSet(
            category = cms.uint32(0),
            cut = cms.string("tauIdMVAIsoPhase2Eff95"),
...
process.rerunDiscriminationByIsolationMVAPhase2VLoose.mapping[0].cut = cms.string("tauIdMVAIsoPhase2Eff90")
process.rerunDiscriminationByIsolationMVAPhase2Loose = process.rerunDiscriminationByIsolationMVAPhase2VVLoose.clone()
process.rerunDiscriminationByIsolationMVAPhase2Loose.mapping[0].cut = cms.string("tauIdMVAIsoPhase2Eff80")
process.rerunDiscriminationByIsolationMVAPhase2Medium = process.rerunDiscriminationByIsolationMVAPhase2VVLoose.clone()
process.rerunDiscriminationByIsolationMVAPhase2Medium.mapping[0].cut = cms.string("tauIdMVAIsoPhase2Eff70")
process.rerunDiscriminationByIsolationMVAPhase2Tight = process.rerunDiscriminationByIsolationMVAPhase2VVLoose.clone()
process.rerunDiscriminationByIsolationMVAPhase2Tight.mapping[0].cut = cms.string("tauIdMVAIsoPhase2Eff60")
process.rerunDiscriminationByIsolationMVAPhase2VTight = process.rerunDiscriminationByIsolationMVAPhase2VVLoose.clone()
process.rerunDiscriminationByIsolationMVAPhase2VTight.mapping[0].cut = cms.string("tauIdMVAIsoPhase2Eff50")
process.rerunDiscriminationByIsolationMVAPhase2VVTight = process.rerunDiscriminationByIsolationMVAPhase2VVLoose.clone()
process.rerunDiscriminationByIsolationMVAPhase2VVTight.mapping[0].cut = cms.string("tauIdMVAIsoPhase2Eff40")
